...
<div class="container mt-5 rounded px-5">
    <form>
        ...
        <div class="input-group mb-3">
            <span class="input-group-text" style="width:150px;" id="basic-addon1">Nama Lengkap</span>
        ...
        <div class="input-group mb-3">
            <span class="input-group-text" style="width:150px;" id="basic-addon1">Nomor Telpon</span>
            <input required type="number" class="form-control" aria-label="Username" aria-describedby="basic-addon1">
        </div>
